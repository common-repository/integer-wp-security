 ...
 */
define( 'devsoftin_plugin_name', 'wp_sec' );
...
if ( ! function_exists( 'devsoftIn_wp_sec_notice_actived' ) ) {
	...
	function devsoftIn_wp_sec_notice_actived() {
		...
		if ( get_transient( 'transient_devsoftIn_wp_sec_notice_actived' ) ) {
			$url_image = plugins_url( '/wp-sec/admin/images/imagotype_grey_and_white_shield.png' );
			printf(
				...
				esc_url_raw( admin_url( '?page=devsoftin-wp-sec' ) ),
